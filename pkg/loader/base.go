...
//go:generate mockgen -destination=../mocks/mock_iacconfiguration.go -package=mocks github.com/nonfx/regula/pkg/loader IACConfiguration
//go:generate mockgen -destination=../mocks/mock_configurationdetector.go -package=mocks github.com/nonfx/regula/pkg/loader ConfigurationDetector
//go:generate mockgen -destination=../mocks/mock_inputpath.go -package=mocks github.com/nonfx/regula/pkg/loader InputPath
//go:generate mockgen -destination=../mocks/mock_inputdirectory.go -package=mocks github.com/nonfx/regula/pkg/loader InputDirectory
//go:generate mockgen -destination=../mocks/mock_inputfile.go -package=mocks github.com/nonfx/regula/pkg/loader InputFile
//go:generate mockgen -destination=../mocks/mock_loadedconfigurations.go -package=mocks github.com/nonfx/regula/pkg/loader LoadedConfigurations
