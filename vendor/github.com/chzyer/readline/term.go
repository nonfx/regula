...
//go:build darwin || dragonfly || freebsd || (linux && !appengine) || netbsd || openbsd || solaris || wasip1
// +build darwin dragonfly freebsd linux,!appengine netbsd openbsd solaris wasip1
